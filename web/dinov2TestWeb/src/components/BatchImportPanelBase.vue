...
import { startBatchImportBase, getBatchStatusBase, resetBatchStatusBase } from '../api/base'
...
async function fetchStatus() {
  try {
    const res = await getBatchStatusBase()
...
<template>
  <div class="batch-panel">
    <div class="panel-header">
      <h3 class="panel-title">批量导入 (Base 模型)</h3>
      <span
        class="status-badge"
